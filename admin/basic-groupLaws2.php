      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຕາມກົດໝາຍ ແລະ ຂໍ້ຂັດແຍ່ງ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຕາມກົດໝາຍ ແລະ ຂໍ້ຂັດແຍ່ງ</B></li>
...
<input type="text" class="form-control" id="Group_ID"  placeholder="ປ້ອນລະຫັດໝວດ"  name="Group_ID">
                ...
                <?php
                 ...
                 $sql = "SELECT * FROM KHT_Rpt_SumByLaws_Civll";
