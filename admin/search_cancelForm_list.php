...
<tbody id="users">
                ...
                <td>
                        ...
                        <td align='center'>
                        <a href="pages/delete_FrmCancelForm_List.php?PrisonerID=<?php echo $result['PrisonerID']?>" class="btn btn-danger"  onclick=" return confirm('ທານຕ້ອງການລົບຂໍ້ມູນນີ້ແທ້ ຫຼື ບໍ..?')"><i class="fas fa-trash fa-sm"></i></a>
                        </td>
