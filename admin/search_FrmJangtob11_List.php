...
?>
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and KHT_Order_Upsan.date between '$start' and '$end'";}


                if($Order_ID==""){$d="";}
                else{ $d="and (KHT_Order_Upsan.Order_ID like N'%$Order_ID%' or KHT_Order_Upsan.Order_ID like N'$Order_ID%')";}

              

                if($Order_No==""){$b="";}
                else{ $b="and (KHT_Order_Upsan.Order_No like N'%$Order_No%' or KHT_Order_Upsan.Order_No like N'$Order_No%')";}


                $i=1;
                $sql = "SELECT * FROM KHT_Order_Upsan WHERE 1=1 $btw $d $b";
