  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <!-- Topbar ແລະ ໜັງສືນໍາສົ່ງຂອງແຕ່ລະຂັ້ນ-->
        <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຄໍາຮ້ອງຂໍຄວາມເປັນທໍາຂາອອກ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຄໍາຮ້ອງຂໍຄວາມເປັນທໍາຂາອອກ</li>
              ...
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                ?>
                    ...
                    <tbody id="users">
                        ...
                        <td>
                        <a href="app/edit_FrmNoticeLegalOut_List.php?Item_ID=<?PHP echo $result["Item_ID"]; ?>" class="btn btn-success"><i class="fas fa-edit fa-sm"></i> </a>
                        </td>
                        <td align='center'>
