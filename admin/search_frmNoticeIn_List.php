...
?>
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and KHT_Save_Kahasathan.date between '$start' and '$end'";}

                if($Order_ID==""){$b="";}
                else{ $b="and (KHT_Save_Kahasathan.Order_ID like N'%$Order_ID%' or KHT_Save_Kahasathan.Order_ID like N'$Order_ID%')";}

                if($Order_No==""){$c="";}
                else{ $c="and (KHT_Save_Kahasathan.Order_No like N'%$Order_No%' or KHT_Save_Kahasathan.Order_No like N'$Order_No%')";}

                $i=1;
                $sql = "SELECT * FROM KHT_Save_Kahasathan WHERE 1=1 $btw $b $c";
