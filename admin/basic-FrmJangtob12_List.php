...
<script>
     ...
     //   alert(start);
				$.post("search_FrmJangtob12_List.php",{
					start:start,
					end:end,
          Order_ID:Order_ID,
          Order_No:Order_No
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">ຄໍາສັ່ງຈັບຕົວ</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                <div class="input-group">
                  ...
                  <div class="col-lg-2">
                   <lable>ເລກທີຄຳສັ່ງ</lable>
                    ...
                    <a href="app/add_FrmJangtob12_List.php" class="btn btn-success"><i class="fas fa-plus fa-sm"></i> </a>
                  </div>
                  </div>
                ...
                $sql = "SELECT * FROM KHT_Order_Juptua ";
                ...
                ?>
                    ...
                    <tbody id="users">
                        ...
                        <td>
                        <a href="app/edit_FrmJangtob12_List.php?Order_ID=<?PHP echo $result["Order_ID"]; ?>" class="btn btn-success"><i class="fas fa-edit fa-sm"></i> </a>
                        </td>
                        <td align='center'>
                        <a href="pages/delete_FrmJangtob12_List.php?Order_ID=<?php echo $result['Order_ID']?>" class="btn btn-danger"  onclick=" return confirm('ທານຕ້ອງການລົບຂໍ້ມູນນີ້ແທ້ ຫຼື ບໍ..?')"><i class="fas fa-trash fa-sm"></i></a>
                        </td>
