      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ບໍ່ຕໍ່ກໍານົດເວລາການສືບສວນ-ສອບສວນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ບໍ່ຕໍ່ກໍານົດເວລາການສືບສວນ-ສອບສວນ</li>
                ...
                <div class="input-group">
                  ...
                  <div class="col-lg-2">
                   <lable>ເລກທີຄຳສັ່ງ</lable>
                    ...
                    <a href="app/add_FrmJangtob7_List.php" class="btn btn-success"><i class="fas fa-plus fa-sm"></i> </a>  
                  </div>
                  </div>
