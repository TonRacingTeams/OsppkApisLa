...
?>
             <div id='show' class="table-responsive p-10">
                ...
                // else{ $btw="and Khet_Rpt.Year_Data = '$start'";}
                 ...
                 if($Group_ID==""){$a="";}
                 else{ $a="and (KHT_Rpt_DecisionAY_SumByLaw.Group_ID like N'%$Group_ID%' or KHT_Rpt_DecisionAY_SumByLaw.Group_ID like N'$Group_ID%')";}


                 if($Group_No==""){$b="";}
                 else{ $b="and (KHT_Rpt_DecisionAY_SumByLaw.Group_No like N'%$Group_No%' or KHT_Rpt_DecisionAY_SumByLaw.Group_No like N'$Group_No%')";}

                 if($Law_No==""){$c="";}
                 else{ $c="and (KHT_Rpt_DecisionAY_SumByLaw.Law_No like N'%$Law_No%' or KHT_Rpt_DecisionAY_SumByLaw.Law_No like N'$Law_No%')";}




                $i=1;
                $sql = "SELECT * FROM KHT_Rpt_DecisionAY_SumByLaw WHERE 1=1 $a $b $c ";
