<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and KHT_Orders.date between '$start' and '$end'";}


              

                if($Order_No==""){$b="";}
                else{ $b="and (KHT_Orders.Order_No like N'%$Order_No%' or KHT_Orders.Order_No like N'$Order_No%')";}

                if($Order_ID==""){$d="";}
                else{ $d="and (KHT_Orders.Order_ID like N'%$Order_ID%' or KHT_Orders.Order_ID like N'$Order_ID%')";}
