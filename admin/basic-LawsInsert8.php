...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຂໍ້ມູນອື່ນໆ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຂໍ້ມູນອື່ນໆ</B></li>
          ...
          <div class="row">
            ...
            <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                <div class="col-lg-2"><br>
                    ...
                    <a href="app/add_FrmLawsInsert8.php" class="btn btn-success"><i class="fas fa-plus fa-sm"></i> </a>
                    </div>
      ...
      <a href="pages/Update_FrmLawsInsert8.php?Law_ID=<?PHP echo $result["Law_ID"]; ?>" class="btn btn-success"><i class="fas fa-edit fa-sm"></i> </a>
      
      </td>
      <td align='center'>
      <a href="pages/Delete_FrmLawsInsert8.php?Law_ID=<?php echo $result['Law_ID']?>" class="btn btn-danger"  onclick=" return confirm('ທານຕ້ອງການລົບຂໍ້ມູນນີ້ແທ້ ຫຼື ບໍ..?')"><i class="fas fa-trash fa-sm"></i></a>
      </td>
