    ...
    //  alert('hellow');
       ...
       var Item_No=$("#Item_No").val();
        var Item_ID=$("#Item_ID").val();
				...
				$.get("search_frmrequestrtin-list.php",{
					start:start,
					end:end,
          Item_No:Item_No,
          Item_ID:Item_ID
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Respond_Civil" name="Respond_Civil" aria-describedby="Respond_Civil" required>
                    </div>

                    <div class="form-group">
                      <label for="Problem">ກ່ຽວເລື່ອງ</label>
                      <input type="pastextsword" class="form-control" id="Problem" name="Problem" required>
                    </div>
