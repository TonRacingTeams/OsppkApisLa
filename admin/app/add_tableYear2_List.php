                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Refer_To" name="Refer_To" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="OSPP_Prov">ລະຫວ່າງ</label>
                      <input type="password" class="form-control" id="OSPP_Prov" name="OSPP_Prov" required>
                    </div>


                    <div class="form-group">
                      <label for="Conclution">ດ້ວຍເຫດນີ້</label>
                      <input type="text" class="form-control" id="Conclution" name="Conclution" required>
                    </div>
