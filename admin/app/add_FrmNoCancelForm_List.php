                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="TotalID" name="TotalID" aria-describedby="PrisonerID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Takebody">ຖືກຈັບຕົວວັນເດືອນປີ</label>
                      <input type="password" class="form-control" id="Takebody" name="Takebody" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="Birthday" name="Birthday" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="addhome" name="addhome" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="To_wrong" name="To_wrong" required>
                    </div>

                    <div class="form-group">
                      <label for="whyhurt">ເຈັບເປັນຫຍັງ</label>
                      <input type="password" class="form-control" id="whyhurt" name="whyhurt" required>
                    </div>


                    <div class="form-group">
                      <label for="camp">ຄ້າຍຄຸມຂັງ</label>
                      <input type="password" class="form-control" id="camp" name="camp" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="hotpital" name="hotpital" required>
                    </div>

                    <div class="form-group">
                      <label for="addrese">ຢູ່ບ້ານ</label>
                      <input type="password" class="form-control" id="addrese" name="addrese" required>
                    </div>
