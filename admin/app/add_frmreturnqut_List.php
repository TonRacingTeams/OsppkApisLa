                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Problem" name="Problem" aria-describedby="Problem" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Out_Comment">ບ່ອນສົ່ງ</label>
                      <input type="text" class="form-control" id="Out_Comment" name="Out_Comment" required>
                    </div>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-frmreturnqut_List.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
