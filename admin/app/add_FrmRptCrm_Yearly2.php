                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="Item_Date" name="Item_Date" required>
                    </div>


                    <div class="form-group">
                      <label for="Full_Name">ຊື່ ແລະ ນາມສະກຸນ</label>
                      <input type="password" class="form-control" id="Full_Name" name="Full_Name" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Date_Birth" name="Date_Birth" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Deci_No" name="Deci_No" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Deci_Date" name="Deci_Date" required>
                    </div>

                    <div class="form-group">
                      <label for="Date_Jub">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="text" class="form-control" id="Date_Jub" name="Date_Jub" required>
                    </div>

                    <div class="form-group">
                      <label for="Kankatham">ຂໍ້ຫາການກະທຳຜີດ</label>
                      <input type="text" class="form-control" id="Kankatham" name="Kankatham" required>
                    </div>

                    <div class="form-group">
                      <label for="Data_holding">ສຳນວນຄະດີ</label>
                      <input type="text" class="form-control" id="Data_holding" name="Data_holding" required>
                    </div>

                    <div class="form-group">
                      <label for="Santad">ທາງອາຍາ(ຕັດສິນລົງໂທດ)</label>
                      <input type="text" class="form-control" id="Santad" name="Santad" required>
                    </div>

                    <div class="form-group">
                      <label for="Pheng_Total">ທາງແພ່ງ(ຈຳນວນ)</label>
                      <input type="text" class="form-control" id="Pheng_Total" name="Pheng_Total" required>
                    </div>

                    <div class="form-group">
                      <label for="Pheng_Paid">ຈ່າຍແລ້ວ</label>
                      <input type="text" class="form-control" id="Pheng_Paid" name="Pheng_Paid" required>
                    </div>

                    <div class="form-group">
                      <label for="Pheng_Remain">ຍັງເຫຼືອ</label>
                      <input type="text" class="form-control" id="Pheng_Remain" name="Pheng_Remain" required>
                    </div>

                    <div class="form-group">
                      <label for="Penaty_Tatol">ຄ່າປັບໄໝ(ຈຳນວນລວມ)</label>
                      <input type="text" class="form-control" id="Penaty_Tatol" name="Penaty_Tatol" required>
                    </div>

                    <div class="form-group">
                      <label for="Penaty_Paid">ຈ່າຍແລ້ວ</label>
                      <input type="text" class="form-control" id="Penaty_Paid" name="Penaty_Paid" required>
                    </div>

                    <div class="form-group">
                      <label for="Penaty_Remain">ຍັງເຫຼືອ</label>
                      <input type="text" class="form-control" id="Penaty_Remain" name="Penaty_Remain" required>
                    </div>
