      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຄະດີແພ່ງ,ການຄ້າ,ຄອບຄົວ ແລະ ເດັກ ທີ່ໄອຍະການປະຊາຊົນເປັນໂຈດ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຄະດີແພ່ງ,ການຄ້າ,ຄອບຄົວ ແລະ ເດັກ ທີ່ໄອຍະການປະຊາຊົນເປັນໂຈດ</li>
            </ol>
          </div>
              ...
              <div class="card mb-4">
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Pers_Name">ຜູ້ຖະແຫຼງຕໍ່ສານ</label>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmLaw_Files_Labieb.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
