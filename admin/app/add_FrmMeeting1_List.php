                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="narcotic_numberID" name="narcotic_numberID" aria-describedby="narcotic_numberID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="nemeral">ສະບັບເລກທີ</label>
                      <input type="password" class="form-control" id="nemeral" name="nemeral" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_name">ຊື່</label>
                      <input type="password" class="form-control" id="narcotic_name" name="narcotic_name" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_lat">ນາມສະກຸນ</label>
                      <input type="password" class="form-control" id="narcotic_lat" name="narcotic_lat" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_false">ອາຍຸເວລາກະທຳຜິດ</label>
                      <input type="password" class="form-control" id="narcotic_false" name="narcotic_false" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_NationNm">ສັນຊາດ</label>
                      <input type="password" class="form-control" id="narcotic_NationNm" name="narcotic_NationNm" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_sex">ເພດ</label>
                      <input type="password" class="form-control" id="narcotic_sex" name="narcotic_sex" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_first_job_to_bearrested">ກ່ອນຖືກຈັບຕົວ(ອາຊີບ)</label>
                      <input type="password" class="form-control" id="narcotic_first_job_to_bearrested" name="narcotic_first_job_to_bearrested" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_Village">ບ້ານ</label>
                      <input type="password" class="form-control" id="narcotic_Village" name="narcotic_Village" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_DistrictBorn">ເມືອງ</label>
                      <input type="password" class="form-control" id="narcotic_DistrictBorn" name="narcotic_DistrictBorn" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_ProvinceBorn">ແຂວງ</label>
                      <input type="password" class="form-control" id="narcotic_ProvinceBorn" name="narcotic_ProvinceBorn" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_day_to_be_arrested">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="password" class="form-control" id="narcotic_day_to_be_arrested" name="narcotic_day_to_be_arrested" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_charge">ຂໍ້ຫາການເຮັດຜິດ</label>
                      <input type="password" class="form-control" id="narcotic_charge" name="narcotic_charge" required>
                    </div>

                    <div class="form-group">
                      <label for="wrongdetail">ລາຍລະອຽດການເຮັດຜິດ</label>
                      <input type="password" class="form-control" id="wrongdetail" name="wrongdetail" required>
                    </div>

                    <div class="form-group">
                      <label for="narcotic_to_judge">ສານຕັດສີນລົງໂທດ</label>
                      <input type="password" class="form-control" id="narcotic_to_judge" name="narcotic_to_judge" required>
                    </div>

                    <div class="form-group">
                      <label for="install">ລົງວັນທີ</label>
                      <input type="password" class="form-control" id="install" name="install" required>
                    </div>

                    <div class="form-group">
                      <label for="items_time">ໄດ້ຮັບການຜ່ອນໂທດ(ຈຳນວນຄັ້ງ)</label>
                      <input type="password" class="form-control" id="items_time" name="items_time" required>
                    </div>

                    <div class="form-group">
                      <label for="items_year">ຈຳນວນປີ</label>
                      <input type="password" class="form-control" id="items_year" name="items_year" required>
                    </div>

                    <div class="form-group">
                      <label for="items_Month">ຈຳນວນເດືອນ</label>
                      <input type="password" class="form-control" id="items_Month" name="items_Month" required>
                    </div>

                    <div class="form-group">
                      <label for="to_act_year">ປະຕິບັດໂທດແລ້ວຈັກປີ</label>
                      <input type="password" class="form-control" id="to_act_year" name="to_act_year" required>
                    </div>

                    <div class="form-group">
                      <label for="penalty_yet">ໂທດທີ່ຍັງເຫຼືອ</label>
                      <input type="password" class="form-control" id="penalty_yet" name="penalty_yet" required>
                    </div>

                    <div class="form-group">
                      <label for="Type_penalty">ປະເພດດັດສ້າງ</label>
                      <input type="password" class="form-control" id="Type_penalty" name="Type_penalty" required>
                    </div>

                    <div class="form-group">
                      <label for="ApaiyaTol">ອະໄພຍະໂທດປີ</label>
                      <input type="password" class="form-control" id="ApaiyaTol" name="ApaiyaTol" required>
                    </div>

                    <div class="form-group">
                      <label for="rates">ຄ່າປັບໄໝ(ສະກຸນເງີນ)</label>
                      <input type="password" class="form-control" id="rates" name="rates" required>
                    </div>

                    <div class="form-group">
                      <label for="total">ຈຳນວນລວມ</label>
                      <input type="password" class="form-control" id="total" name="total" required>
                    </div>

                    <div class="form-group">
                      <label for="paid">ຈ່າຍແລ້ວ</label>
                      <input type="password" class="form-control" id="paid" name="paid" required>
                    </div>

                    <div class="form-group">
                      <label for="yat">ຍັງເຫຼືອ</label>
                      <input type="password" class="form-control" id="yat" name="yat" required>
                    </div>

                    <div class="form-group">
                      <label for="in_debt">ຈຳນວນຜ່ອນ</label>
                      <input type="password" class="form-control" id="in_debt" name="in_debt" required>
                    </div>

                    <div class="form-group">
                      <label for="to_reduce_sentence">ເປີເຊັນຜ່ອນຄ່າປັບໄໝ</label>
                      <input type="password" class="form-control" id="to_reduce_sentence" name="to_reduce_sentence" required>
                    </div>

                    <div class="form-group">
                      <label for="Remark">ຈຳນວນຜ່ອນ</label>
                      <input type="password" class="form-control" id="Remark" name="Remark" required>
                    </div>
