      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມປ່ອຍຕົວຕາມມາດຕາ 105</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມປ່ອຍຕົວຕາມມາດຕາ 105</li>
            </ol>
          </div>
...
$ConvietID=$_GET['ConvietID'];
$sql="SELECT * FROM KHT_Conviet_105 WHERE ConvietID='$ConvietID' ";
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="ConvietID">ລະຫັດ</label>
                      <input type="text" name="ConvietID" class="form-control" readonly value=<?=$ConvietID?>><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Kok_Name">ຊື່ນັກໂທດ</label>
                      <input type="text" name="Kok_Name" class="form-control" value="<?php echo $row['Kok_Name']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_surname">ນາມສະກຸນ</label>
                      <input type="text" name="Kok_surname" class="form-control" value="<?php echo $row['Kok_surname']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_timemake">ອາຍຸເວລາກະທຳຜິດ</label>
                      <input type="text" name="Kok_timemake" class="form-control" value="<?php echo $row['Kok_timemake']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="kok_sex">ເພດ</label>
                      <input type="text" name="kok_sex" class="form-control" value="<?php echo $row['kok_sex']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_National">ສັນຊາດ</label>
                      <input type="text" name="Kok_National" class="form-control" value="<?php echo $row['Kok_National']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="befor_job">ກ່ອນຖືກ(ອາຊີບ)</label>
                      <input type="text" name="befor_job" class="form-control" value="<?php echo $row['befor_job']?>"><br>
        </div>


                    <!-- <div class="form-group">
                      <label for="befor_Village">ບ້ານ</label>
                      <input type="text" name="befor_Village" class="form-control" value="<?php echo $row['befor_Village']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="befor_District">ເມືອງ</label>
                      <input type="text" name="befor_District" class="form-control" value="<?php echo $row['befor_District']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="befor_Province">ແຂວງ</label>
                      <input type="text" name="befor_Province" class="form-control" value="<?php echo $row['befor_Province']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="Kok_punish">ສານຕັດສິນລົງໂທດ</label>
                      <input type="text" name="Kok_punish" class="form-control" value="<?php echo $row['Kok_punish']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      <label for="Kok_Dtouch">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="date" name="Kok_Dtouch" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Con_count">ໄດ້ຮັບການຜ່ອນໂທດ(ຈຳນວນຄັ້ງ)</label>
                      <input type="text" name="Con_count" class="form-control" value="<?php echo $row['Con_count']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Con_year">ຈຳນວນປີ</label>
                      <input type="text" name="Con_year" class="form-control" value="<?php echo $row['Con_year']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="Con_month">ຈັກເດືອນ</label>
                      <input type="text" name="Con_month" class="form-control" value="<?php echo $row['Con_month']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="Con_Datefor">ປະເພດດັດສ້າງ</label>
                      <input type="text" name="Con_Datefor" class="form-control" value="<?php echo $row['Con_Datefor']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      <label for="Beleft">ຍັງເຫຼືອ</label>
                      <input type="text" name="Beleft" class="form-control" value="<?php echo $row['Beleft']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Brithday">ວັນເດືອນປີໝົດໂທດ</label>
                      <input type="date" name="Brithday" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_Total">ຄ່າປັບໄໝ(ຈຳນວນລວມ)</label>
                      <input type="text" name="Kok_Total" class="form-control" value="<?php echo $row['Kok_Total']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_Paid">ຈ່າຍແລ້ວ</label>
                      <input type="text" name="Kok_Paid" class="form-control" value="<?php echo $row['Kok_Paid']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_Slacken">ຈຳນວນຜ່ອນ</label>
                      <input type="text" name="Kok_Slacken" class="form-control" value="<?php echo $row['Kok_Slacken']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Kok_Beleft">ຍັງເຫຼືອ</label>
                      <input type="text" name="Kok_Beleft" class="form-control" value="<?php echo $row['Kok_Beleft']?>"><br>
        </div>
...
<input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-FrmMeeting_List.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmMeeting_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
