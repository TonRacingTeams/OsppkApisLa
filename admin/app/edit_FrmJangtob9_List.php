      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຄໍາສັ່ງປ່ອຍຕົວຜູ້ຖືກຫາ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຄໍາສັ່ງປ່ອຍຕົວຜູ້ຖືກຫາ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Order_Poytua WHERE Order_ID='$Order_ID' ";
...
?>
        ...
        <td><a href="../basic-FrmJangtob9_List.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmJangtob9_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
