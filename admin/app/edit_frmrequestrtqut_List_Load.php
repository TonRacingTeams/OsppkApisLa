      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຄໍາສັ່ງກັກຂັງພາງ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຄໍາສັ່ງກັກຂັງພາງ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Orders_Pang WHERE Order_ID='$Order_ID' ";
...
?>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="date" class="form-control" value="<?php echo $row['dates']?>"><br>
                    </div>
        ...
        <td><a href="../basic-frmrequestrtqut_List_Load.php" class="btn btn-danger">Cancle</a></td>
                    ...
                    <a href='../basic-frmrequestrtqut_List_Load.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
