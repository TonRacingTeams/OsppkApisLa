                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="slacken_nameID" name="slacken_nameID" aria-describedby="PrisonerID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="nemeral">ເລກທີ</label>
                      <input type="text" class="form-control" id="nemeral" name="nemeral" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="slacken_name" name="slacken_name" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_Lat">ນາມສະກຸນ</label>
                      <input type="text" class="form-control" id="slacken_Lat" name="slacken_Lat" required>
                    </div>

                    <div class="form-group">
                      <label for="action_false">ອາຍຸເວລາກະທຳຜິດ</label>
                      <input type="text" class="form-control" id="action_false" name="action_false" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_sex">ເພດ</label>
                      <input type="text" class="form-control" id="slacken_sex" name="slacken_sex" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_NationNm">ສັນຊາດ</label>
                      <input type="text" class="form-control" id="slacken_NationNm" name="slacken_NationNm" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_first_job_to_bearrested">ກ່ອນຖືກຈັບ(ອາຊີບ)</label>
                      <input type="text" class="form-control" id="slacken_first_job_to_bearrested" name="slacken_first_job_to_bearrested" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_Village">ບ້ານ</label>
                      <input type="text" class="form-control" id="slacken_Village" name="slacken_Village" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_DistrictBorn">ເມືອງ</label>
                      <input type="text" class="form-control" id="slacken_DistrictBorn" name="slacken_DistrictBorn" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_ProvinceBorn">ແຂວງ</label>
                      <input type="text" class="form-control" id="slacken_ProvinceBorn" name="slacken_ProvinceBorn" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_day_to_be_arrested">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="text" class="form-control" id="slacken_day_to_be_arrested" name="slacken_day_to_be_arrested" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="slacken_charge" name="slacken_charge" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="items_time" name="items_time" required>
                    </div>

                    <div class="form-group">
                      <label for="items_year">ຈຳນວນປີ</label>
                      <input type="text" class="form-control" id="items_year" name="items_year" required>
                    </div>

                    <div class="form-group">
                      <label for="items_Month">ຈຳນວນເດືອນ</label>
                      <input type="text" class="form-control" id="items_Month" name="items_Month" required>
                    </div>

                    <div class="form-group">
                      <label for="slacken_to_judge">ສານຕັດສິນລົງໂທດ</label>
                      <input type="text" class="form-control" id="slacken_to_judge" name="slacken_to_judge" required>
                    </div>

                    <div class="form-group">
                      <label for="to_act_year">ປະຕິບັດໂທດແລ້ວຈັກປີ</label>
                      <input type="text" class="form-control" id="to_act_year" name="to_act_year" required>
                    </div>

                    <div class="form-group">
                      <label for="penalty_yet">ໂທດທີ່ຍັງເຫຼືອ</label>
                      <input type="text" class="form-control" id="penalty_yet" name="penalty_yet" required>
                    </div>

                    <div class="form-group">
                      <label for="Type_penalty">ປະເພດດັດສ້າງ</label>
                      <input type="text" class="form-control" id="Type_penalty" name="Type_penalty" required>
                    </div>

                    <div class="form-group">
                      <label for="ApaiyaTol">ອະໄພຍະໂທດປີ</label>
                      <input type="text" class="form-control" id="ApaiyaTol" name="ApaiyaTol" required>
                    </div>

                    <div class="form-group">
                      <label for="rates">ທາງແພ່ງ(ສະກຸນເງີນ)</label>
                      <input type="text" class="form-control" id="rates" name="rates" required>
                    </div>

                    <div class="form-group">
                      <label for="Cltotal">ຈຳນວນລວມ</label>
                      <input type="text" class="form-control" id="Cltotal" name="Cltotal" required>
                    </div>

                    <div class="form-group">
                      <label for="Clpaid">ຈ່າຍແລ້ວ</label>
                      <input type="text" class="form-control" id="Clpaid" name="Clpaid" required>
                    </div>

                    <div class="form-group">
                      <label for="Clin_debt">ຍັງເຫຼືອ</label>
                      <input type="text" class="form-control" id="Clin_debt" name="Clin_debt" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="yat" name="yat" required>
                    </div>

                    <div class="form-group">
                      <label for="in_debt">ຈຳນວນຜ່ອນ</label>
                      <input type="text" class="form-control" id="in_debt" name="in_debt" required>
                    </div>
