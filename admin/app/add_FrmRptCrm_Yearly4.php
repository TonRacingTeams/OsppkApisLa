      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຂໍ້ມູນສະຖິຕິປະຈຳເດືອນເຂດ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຂໍ້ມູນສະຖິຕິປະຈຳເດືອນເຂດ</li>
            </ol>
          </div>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Order_No">ເລກນັບ</label>
                      <input type="text" class="form-control" id="Order_No" name="Order_No" aria-describedby="Order_No" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Description">ລາຍການຂໍ້ມູນ</label>
                      <input type="password" class="form-control" id="Description" name="Description" required>
                    </div>


                    <div class="form-group">
                      <label for="M1">ເດືອນ1</label>
                      <input type="password" class="form-control" id="M1" name="M1" required>
                    </div>
                   

          
                    <div class="form-group">
                      <label for="M2">ເດືອນ2</label>
                    ...
                    <div class="form-group">
                      <label for="M3">ເດືອນ3</label>
                      <input type="text" class="form-control" id="M3" name="M3" required>
                    </div>

                    

                    <div class="form-group">
                      <label for="M4">ເດືອນ4</label>
                      <input type="text" class="form-control" id="M4" name="M4" required>
                    </div>


                    <div class="form-group">
                      <label for="M5">ເດືອນ5</label>
                      <input type="text" class="form-control" id="M5" name="M5" required>
                    </div>



                    <div class="form-group">
                      <label for="M6">ເດືອນ6</label>
                      <input type="text" class="form-control" id="M6" name="M6" required>
                    </div>

                    

                    <div class="form-group">
                      <label for="M7">ເດືອນ7</label>
                      <input type="text" class="form-control" id="M7" name="M7" required>
                    </div>

                    <div class="form-group">
                      <label for="M8">ເດືອນ8</label>
                      <input type="text" class="form-control" id="M8" name="M8" required>
                    </div>

                    

                    <div class="form-group">
                      <label for="M9">ເດືອນ9</label>
                      <input type="text" class="form-control" id="M9" name="M9" required>
                    </div>

                    <div class="form-group">
                      <label for="M10">ເດືອນ10</label>
                      <input type="text" class="form-control" id="M10" name="M10" required>
                    </div>

                    <div class="form-group">
                      <label for="M11">ເດືອນ11</label>
                      <input type="text" class="form-control" id="M11" name="M11" required>
                    </div>

                    <div class="form-group">
                      <label for="M12">ເດືອນ12</label>
                      <input type="text" class="form-control" id="M12" name="M12" required>
                    </div>

                    <div class="form-group">
                      <label for="Year_Data">ປີ</label>
                      <input type="text" class="form-control" id="Year_Data" name="Year_Data" required>
                    </div>

                    <div class="form-group">
                      <label for="Khet_No">ໝາຍເຫດ</label>
                      <input type="text" class="form-control" id="Khet_No" name="Khet_No" required>
                    </div>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmRptCrm_Yearly4.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
