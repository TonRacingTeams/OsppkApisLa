      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມບັນຊີຜູ້ຖືກຫາທັງໝົດ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມບັນຊີຜູ້ຖືກຫາທັງໝົດ</li>
            </ol>
          </div>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="numberID" name="numberID" aria-describedby="numberID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Alleged_day_to_be_arrested">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="text" class="form-control" id="Alleged_day_to_be_arrested" name="Alleged_day_to_be_arrested" required>
                    </div>


                    <div class="form-group">
                      <label for="Alleged_Name">ຊື່</label>
                      <input type="text" class="form-control" id="Alleged_Name" name="Alleged_Name" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Alleged_latname" name="Alleged_latname" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Alleged_BO">ວັນເດືອນປີເກີດ</label>
                      <input type="text" class="form-control" id="Alleged_BO" name="Alleged_BO" required>
                    </div>


                    <div class="form-group">
                      <label for="Alleged_Sex">ເພດ</label>
                      <input type="text" class="form-control" id="Alleged_Sex" name="Alleged_Sex" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Alleged_NationNm">ສັນຊາດ</label>
                      <input type="text" class="form-control" id="Alleged_NationNm" name="Alleged_NationNm" required>
                    </div>

                    <div class="form-group">
                      <label for="Alleged_first_job_to_bearrested">ກ່ອນຖືກຈັບ(ອາຊີບ)</label>
                      <input type="text" class="form-control" id="Alleged_first_job_to_bearrested" name="Alleged_first_job_to_bearrested" required>
                    </div>

                    <div class="form-group">
                      <label for="Alleged_Village">ກ່ອນຖືກຈັບ(ບ້ານ)</label>
                      <input type="text" class="form-control" id="Alleged_Village" name="Alleged_Village" required>
                    </div>

                    <div class="form-group">
                      <label for="Alleged_DistrictBorn">ກ່ອນຖືກຈັບ(ເມືອງ)</label>
                      <input type="text" class="form-control" id="Alleged_DistrictBorn" name="Alleged_DistrictBorn" required>
                    </div>

                    <div class="form-group">
                      <label for="Alleged_ProvinceBorn">ກ່ອນຖືກຈັບ(ແຂວງ)</label>
                      <input type="text" class="form-control" id="Alleged_ProvinceBorn" name="Alleged_ProvinceBorn" required>
                    </div>

                    <div class="form-group">
                      <label for="Alleged_charge">ຂໍ້ຫາການກະທຳຜິດ</label>
                      <input type="text" class="form-control" id="Alleged_charge" name="Alleged_charge" required>
                    </div>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmDecision_List.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
