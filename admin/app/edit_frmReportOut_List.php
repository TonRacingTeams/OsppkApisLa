      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມບັນຊີການກໍ່ອາດຊະຍາກຳ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມບັນຊີການກໍ່ອາດຊະຍາກຳ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Criminal_Pers WHERE Item_ID='$Item_ID' ";
              ...
              <div class="card mb-4">
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Item_IDNew">ລະຫັດຜູ້ຖືກຫາ</label>
                      <input type="text" name="Item_IDNew" class="form-control" readonly value="<?php echo $row['Item_IDNew']?>"><br>
                    </div>


                    <div class="form-group">
                      <label for="Item_Date">ວັນເດືອນປີກໍ່ອາສະຍາກຳ</label>
                    ...
                    <div class="form-group">
                      <label for="Pers_Name">ຊື່ ແລະ ນາມສະກຸນ</label>
                      <input type="text" name="Pers_Name" class="form-control" value="<?php echo $row['Pers_Name']?>"><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Problem">ປະເພດ ແລະ ສະຖານການກະທຳຜີດ</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="Age" class="form-control" value="<?php echo $row['Age']?>"><br>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Professional">ອາຊີບ</label>
                      <input type="text" name="Professional" class="form-control" value="<?php echo $row['Professional']?>"><br>
                    </div>
                   

          
                    <!-- <div class="form-group">
                      <label for="Race">ຊົນເຜົ່າ</label>
                      <input type="text" name="Race" class="form-control" value="<?php echo $row['Race']?>"><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Original">ເຊື້ອຊາດ</label>
                      <input type="text" name="Original" class="form-control" value="<?php echo $row['Original']?>"><br>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Nationallity">ສັນຊາດ</label>
                      <input type="text" name="Nationallity" class="form-control" value="<?php echo $row['Nationallity']?>"><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Country">ປະເທດ</label>
                      <input type="text" name="Country" class="form-control" value="<?php echo $row['Country']?>"><br>
                    </div>


                    <div class="form-group">
                      <label for="Used_Tool">ອຸປະກອນການໃຊ້ກະທຳຜິດ</label>
                      <input type="text" name="Used_Tool" class="form-control" value="<?php echo $row['Used_Tool']?>"><br>
                    </div>
                   

          
                    <div class="form-group">
                      <label for="Resion">ສາເຫດ</label>
                      <input type="text" name="Resion" class="form-control" value="<?php echo $row['Resion']?>"><br>
                    </div>

                    <div>
                    <input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-FrmReportOut_List.php" class="btn btn-danger">Cancle</a></td> -->
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmReportOut_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
