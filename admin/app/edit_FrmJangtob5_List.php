...
<script>
    ...
    //  alert('hellow');
        ...
        var Order_No=$("#Order_No").val();
				...
				$.post("search_FrmJangtob5_List.php",{
					start:start,
					end:end,
          Order_ID:Order_ID,
          Order_No:Order_No
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຕໍ່ກໍານົດເວລາການສືບສວນ-ສອບສວນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຕໍ່ກໍານົດເວລາການສືບສວນ-ສອບສວນ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Order_To_Time WHERE Order_ID='$Order_ID' ";
...
?>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Order_ID">ລະຫັດເອກະສານ</label>
                      <input type="text" name="Order_ID" class="form-control" readonly value=<?=$Order_ID?>><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Order_No">ເລກທີຄຳສັ່ງ</label>
                      <input type="text" name="Order_No" class="form-control" value="<?php echo $row['Order_No']?>"><br>
                    </div>


                    <div class="form-group">
                      <label for="date">ວັນທີ</label>
                      <input type="date" name="Item_Date" class="form-control" value="<?php echo $row['dates']?>"><br>
                    </div>
                    ...
                    <!-- <div class="form-group">
                      <label for="Reference">ບ່ອນອີງ</label>
                      <input type="text" name="Reference" class="form-control" value="<?php echo $row['Reference']?>"><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Description">ເນື້ອໃນຄຳສັ່ງ</label>
        ...
        <td><a href="../basic-FrmJangtob5_List.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmJangtob5_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
