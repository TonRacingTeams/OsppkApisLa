      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມການຊັນນະສູດຊາກສົບ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມການຊັນນະສູດຊາກສົບ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Save_Saksop WHERE Order_ID='$Order_ID' ";
...
?>
        ...
        <td><a href="../basic-FrmNoticeLegalIn_List.php" class="btn btn-danger">Cancle</a></td>
