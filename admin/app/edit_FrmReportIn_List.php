      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມກວດຄົ້ນພາຫານະ ແລະ ຕົວບຸກຄົນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມກວດຄົ້ນພາຫານະ ແລະ ຕົວບຸກຄົນ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Sava_Car WHERE Order_ID='$Order_ID' ";
...
?>
        ...
        <td><a href="../basic-FrmReportIn_List.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmReportIn_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
