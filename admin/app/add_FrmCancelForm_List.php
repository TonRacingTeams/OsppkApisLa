                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="releaseID" name="releaseID" aria-describedby="PrisonerID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="DTakebody">ຖືກຈັບຕົວວັນເດືອນປີ</label>
                      <input type="text" class="form-control" id="DTakebody" name="DTakebody" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Law_Total" name="Law_Total" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Nocount" name="Nocount" required>
                    </div>


                    <div class="form-group">
                      <label for="Dday">ວັນທີໝົດໂທດ</label>
                      <input type="text" class="form-control" id="Dday" name="Dday" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Rel_penMonth" name="Rel_penMonth" required>
                    </div>
