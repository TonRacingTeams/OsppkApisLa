      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມອະໄພຍະໂທດປ່ອຍຕົວເນື່ອງໃນໂອກາດວັນຊາດທີ 2 ທັນວາ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມອະໄພຍະໂທດປ່ອຍຕົວເນື່ອງໃນໂອກາດວັນຊາດທີ 2 ທັນວາ</li>
            </ol>
          </div>
...
$slacken_nameID=$_GET['slacken_nameID'];
$sql="SELECT * FROM KHT_slacken WHERE slacken_nameID='$slacken_nameID' ";
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="slacken_nameID">ລະຫັດ</label>
                      <input type="text" name="slacken_nameID" class="form-control" readonly value=<?=$slacken_nameID?>><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="nemeral">ເລກທີ</label>
                      <input type="text" name="nemeral" class="form-control" value="<?php echo $row['nemeral']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Birthday">ລົງວັນທີ</label>
                      <input type="date" name="Brithday" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_name">ຊື່</label>
                      <input type="text" name="slacken_name" class="form-control" value="<?php echo $row['slacken_name']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_Lat">ນາມສະກຸນ</label>
                      <input type="text" name="slacken_Lat" class="form-control" value="<?php echo $row['slacken_Lat']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="action_false">ອາຍຸເວລາກະທຳຜິດ</label>
                      <input type="text" name="action_false" class="form-control" value="<?php echo $row['action_false']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_sex">ເພດ</label>
                      <input type="text" name="slacken_sex" class="form-control" value="<?php echo $row['slacken_sex']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_NationNm">ສັນຊາດ</label>
                      <input type="text" name="slacken_NationNm" class="form-control" value="<?php echo $row['slacken_NationNm']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_first_job_to_bearrested">ກ່ອນຖືກຈັບ(ອາຊີບ)</label>
                      <input type="text" name="slacken_first_job_to_bearrested" class="form-control" value="<?php echo $row['slacken_first_job_to_bearrested']?>"><br>
        </div>

                    <!-- <div class="form-group">
                      <label for="slacken_Village">ບ້ານ</label>
                      <input type="text" name="slacken_Village" class="form-control" value="<?php echo $row['slacken_Village']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_DistrictBorn">ເມືອງ</label>
                      <input type="text" name="slacken_DistrictBorn" class="form-control" value="<?php echo $row['slacken_DistrictBorn']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_ProvinceBorn">ແຂວງ</label>
                      <input type="text" name="slacken_ProvinceBorn" class="form-control" value="<?php echo $row['slacken_ProvinceBorn']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_day_to_be_arrested">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="date" name="slacken_day_to_be_arrested" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="wrongdetail">ລາຍລະອຽດການກະທຳຜິດ</label>
                      <input type="text" name="wrongdetail" class="form-control" value="<?php echo $row['wrongdetail']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_charge">ຂໍ້ຫາການກະທຳຜິດ</label>
                      <input type="text" name="slacken_charge" class="form-control" value="<?php echo $row['slacken_charge']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="comment">ໄລຍະຜ່ອນໂທດ</label>
                      <input type="text" name="comment" class="form-control" value="<?php echo $row['comment']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="items_time">ໄດ້ຮັບຜ່ອນໂທດ(ຈຳນວນຄັ້ງ)</label>
                      <input type="text" name="items_time" class="form-control" value="<?php echo $row['items_time']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="items_year">ຈຳນວນປີ</label>
                      <input type="text" name="items_year" class="form-control" value="<?php echo $row['items_year']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="items_Month">ຈຳນວນເດືອນ</label>
                      <input type="text" name="items_Month" class="form-control" value="<?php echo $row['items_Month']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken_to_judge">ສານຕັດສິນລົງໂທດ</label>
                      <input type="text" name="slacken_to_judge" class="form-control" value="<?php echo $row['slacken_to_judge']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="to_act_year">ປະຕິບັດໂທດແລ້ວຈັກປີ</label>
                      <input type="text" name="to_act_year" class="form-control" value="<?php echo $row['to_act_year']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="penalty_yet">ໂທດທີ່ຍັງເຫຼືອ</label>
                      <input type="text" name="penalty_yet" class="form-control" value="<?php echo $row['penalty_yet']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Type_penalty">ປະເພດດັດສ້າງ</label>
                      <input type="text" name="Type_penalty" class="form-control" value="<?php echo $row['Type_penalty']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="ApaiyaTol">ອະໄພຍະໂທດປີ</label>
                      <input type="text" name="ApaiyaTol" class="form-control" value="<?php echo $row['ApaiyaTol']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="rates">ທາງແພ່ງ(ສະກຸນເງີນ)</label>
                      <input type="text" name="rates" class="form-control" value="<?php echo $row['rates']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Cltotal">ຈຳນວນລວມ</label>
                      <input type="text" name="Cltotal" class="form-control" value="<?php echo $row['Cltotal']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Clpaid">ຈ່າຍແລ້ວ</label>
                      <input type="text" name="Clpaid" class="form-control" value="<?php echo $row['Clpaid']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Clin_debt">ຍັງເຫຼືອ</label>
                      <input type="text" name="Clin_debt" class="form-control" value="<?php echo $row['Clin_debt']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      <label for="paid">ຈ່າຍແລ້ວ</label>
                      <input type="text" name="paid" class="form-control" value="<?php echo $row['paid']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="yat">ຍັງເຫຼືອ</label>
                      <input type="text" name="yat" class="form-control" value="<?php echo $row['yat']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="in_debt">ຈຳນວນຜ່ອນ</label>
                      <input type="text" name="in_debt" class="form-control" value="<?php echo $row['in_debt']?>"><br>
        </div>
...
<input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-FrmMeeting_Return_List.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmMeeting_Return_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
