      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຄໍາສັ່ງບໍ່ລົບລ້າງຄໍາສັ່ງບໍ່ເປີດການສືບສວນ-ສອບສວນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຄໍາສັ່ງບໍ່ລົບລ້າງຄໍາສັ່ງບໍ່ເປີດການສືບສວນ-ສອບສວນ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_Order_No_Delete_Open WHERE Order_ID='$Order_ID' ";
...
?>
        ...
        <td><a href="../basic-FrmReviseOrders_List.php" class="btn btn-danger">Cancle</a></td>
