...
$sql="SELECT * FROM KHT_ReQuestIn WHERE Item_ID='$Item_ID' ";
...
?>
    ...
    <form method="POST" action="update_frmrequesttrueIn-List.php"> -->
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div>
                      ...
                      <input type="submit" value="Update" class="btn btn-success">
                      <td><a href="../basic-frmrequesttrueIn_List.php" class="btn btn-danger">Cancle</a></td>
