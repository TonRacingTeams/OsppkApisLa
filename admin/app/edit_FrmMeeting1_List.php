      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມນັກໂທດຢາເສບຕິດທີ່ມີເງື່ອນໄຂສະເໜີໃຫ້ອະໄພຍະໂທດຜ່ອນໂທດ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມນັກໂທດຢາເສບຕິດທີ່ມີເງື່ອນໄຂສະເໜີໃຫ້ອະໄພຍະໂທດຜ່ອນໂທດ</li>
            </ol>
          </div>
...
$narcotic_numberID=$_GET['narcotic_numberID'];
$sql="SELECT * FROM KHT_narcotic_slacken WHERE narcotic_numberID='$narcotic_numberID' ";
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="narcotic_numberID">ລະຫັດ</label>
                      <input type="text" name="narcotic_numberID" class="form-control" readonly value=<?=$narcotic_numberID?>><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="nemeral">ສະບັບເລກທີ</label>
                      <input type="text" name="nemeral" class="form-control" value="<?php echo $row['nemeral']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_name">ຊື່</label>
                      <input type="text" name="narcotic_name" class="form-control" value="<?php echo $row['narcotic_name']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_lat">ນາມສະກຸນ</label>
                      <input type="text" name="narcotic_lat" class="form-control" value="<?php echo $row['narcotic_lat']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_false">ອາຍຸເວລາກະທຳຜິດ</label>
                      <input type="text" name="narcotic_false" class="form-control" value="<?php echo $row['narcotic_false']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_NationNm">ສັນຊາດ</label>
                      <input type="text" name="narcotic_NationNm" class="form-control" value="<?php echo $row['narcotic_NationNm']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_sex">ເພດ</label>
                      <input type="text" name="narcotic_sex" class="form-control" value="<?php echo $row['narcotic_sex']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_first_job_to_bearrested">ກ່ອນຖືກຈັບຕົວ(ອາຊີບ)</label>
                      <input type="text" name="narcotic_first_job_to_bearrested" class="form-control" value="<?php echo $row['narcotic_first_job_to_bearrested']?>"><br>
        </div>

                    <!-- <div class="form-group">
                      <label for="narcotic_Village">ບ້ານ</label>
                      <input type="text" name="narcotic_Village" class="form-control" value="<?php echo $row['narcotic_Village']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_DistrictBorn">ເມືອງ</label>
                      <input type="text" name="narcotic_DistrictBorn" class="form-control" value="<?php echo $row['narcotic_DistrictBorn']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_ProvinceBorn">ແຂວງ</label>
                      <input type="text" name="narcotic_ProvinceBorn" class="form-control" value="<?php echo $row['narcotic_ProvinceBorn']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_day_to_be_arrested">ວັນເດືອນປີຖືກຈັບຕົວ</label>
                      <input type="date" name="narcotic_day_to_be_arrested" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_charge">ຂໍ້ຫາການເຮັດຜິດ</label>
                      <input type="text" name="narcotic_charge" class="form-control" value="<?php echo $row['narcotic_charge']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="wrongdetail">ລາຍລະອຽດການເຮັດຜິດ</label>
                      <input type="text" name="wrongdetail" class="form-control" value="<?php echo $row['wrongdetail']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="narcotic_to_judge">ສານຕັດສີນລົງໂທດ</label>
                      <input type="text" name="narcotic_to_judge" class="form-control" value="<?php echo $row['narcotic_to_judge']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="install">ລົງວັນທີ</label>
                      <input type="date" name="install" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="items_time">ໄດ້ຮັບການຜ່ອນໂທດ(ຈຳນວນຄັ້ງ)</label>
                    ...
                    <div class="form-group">
                      <label for="to_reduce_sentence">ເປີເຊັນຜ່ອນຄ່າປັບໄໝ</label>
                      <input type="text" name="to_reduce_sentence" class="form-control" value="<?php echo $row['to_reduce_sentence']?>"><br>
        </div> -->
              ...
              <div class="card mb-4">
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Remark">ຈຳນວນຜ່ອນ</label>
...
<input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-FrmMeeting1_List.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmMeeting1_List.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
