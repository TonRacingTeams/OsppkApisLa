      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຄຳຖະແຫລງຄະດີແພ່ງທີ່ໄອຍະການປະຊາຊົນເປັນໂຈດ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຄຳຖະແຫລງຄະດີແພ່ງທີ່ໄອຍະການປະຊາຊົນເປັນໂຈດ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_NoDisagree WHERE Item_ID='$Item_ID' ";
...
<input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-tableYear3.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-tableYear3.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
