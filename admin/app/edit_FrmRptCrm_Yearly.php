      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຕິດຕາມບົດສະຫຼູບຄະດີແພ່ງ (ຂັ້ນຕົ້ນ) ທີ່ໄດ້ສົ່ງສານ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຕິດຕາມບົດສະຫຼູບຄະດີແພ່ງ (ຂັ້ນຕົ້ນ) ທີ່ໄດ້ສົ່ງສານ</li>
            </ol>
          </div>
...
$sql="SELECT * FROM KHT_CanMeetingPh_Case2 WHERE Item_ID='$Item_ID' ";
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Item_ID">ລະຫັດບົດສະຫຼູບ</label>
                      <input type="text" name="Item_ID" class="form-control" readonly value=<?=$Item_ID?>><br>
                    </div>
                   

                    <div class="form-group">
                      <label for="Item_Date">ວັນເດືອນປີສົ່ງບົດສະຫຼູບ</label>
                      <input type="date" name="Item_Date" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>


                    <div class="form-group">
                      <label for="Case_ID">ລະຫັດຄະດີ</label>
                      <input type="text" name="Case_ID" class="form-control" value="<?php echo $row['Case_ID']?>"><br>
        </div>
                   

          
                    <div class="form-group">
                      <label for="Problem">ກ່ຽວເລື່ອງ</label>
                    ...
                    <div class="form-group">
                      <label for="Request_Civil">ໂຈດ</label>
                    ...
                    <div class="form-group">
                      <label for="Related_Pers">ບຸກຄົນທີສາມ</label>
                    ...
                    <div class="form-group">
                      <label for="Pers_Name">ຜູ້ຂຽນບົດສະຫຼຸບ</label>
                      <input type="text" name="Pers_Name" class="form-control" value="<?php echo $row['Pers_Name']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Solv_Name">ຜົນການຕັດສິນຂອງສານ</label>
              ...
              <div class="card mb-4">
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Case_ID">ລະຫັດຄະດີ</label>
                      <input type="date" name="Case_ID" class="form-control" value="<?php echo $row['Case_ID']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      <label for="Problem">ກ່ຽວເລື່ອງ</label>
                      <input type="date" name="Problem" class="form-control" value="<?php echo $row['Problem']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      <label for="Request_Civil">ໂຈດ</label>
                      <input type="date" name="Request_Civil" class="form-control" value="<?php echo $row['Request_Civil']?>"><br>
        </div> -->
...
<input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-FrmRptCrm_Yearly.php" class="btn btn-danger">Cancle</a></td>
            ...
            <!-- <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmRptCrm_Yearly.php' class="btn btn-danger">ຍົກເລີກ</a> -->
                  </form>
                </div>
              </div>
