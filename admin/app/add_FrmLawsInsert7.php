      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຂໍ້ມູນບັນດາຂໍ້ກຳນົດ ແລະ ລະບຽບການ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຂໍ້ມູນບັນດາຂໍ້ກຳນົດ ແລະ ລະບຽບການ</li>
            </ol>
          </div>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-LawsInsert7.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
