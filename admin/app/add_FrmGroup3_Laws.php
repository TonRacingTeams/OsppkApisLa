...
<script>
    ...
    //  alert('hellow');
        ...
        var Law_NmE=$("#Law_NmE").val();
				...
				$.post("search_FrmJangtob2_List.php",{
					Law_ID:Law_ID,
          Law_Name:Law_Name,
          Law_NmE:Law_NmE
				},
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຂໍ້ມູນກ່ຽວກັບກົດໝາຍ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຂໍ້ມູນກ່ຽວກັບກົດໝາຍ</li>
            </ol>
          </div>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Law_ID">ເລກລະຫັດ</label>
                      <input type="text" class="form-control" id="Law_ID" name="Law_ID" aria-describedby="Law_ID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Law_Name">ຊື່ກົດໝາຍ (ພາສາລາວ)</label>
                      <input type="text" class="form-control" id="Law_Name" name="Law_Name" required>
                    </div>


                    <div class="form-group">
                      <label for="Law_NmE">ຊື່ກົດໝາຍ (ພາສາອັງກິດ)</label>
                      <input type="text" class="form-control" id="Law_NmE" name="Law_NmE" required>
                    </div>
                   

          
                    <div class="form-group">
                      <label for="File_Name">ຊື່ file</label>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-groupLaws3.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
