      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຄໍາສັ່ງລົບລ້າງຄໍາສັ່ງເປີດການສືບສວນ-ສອບສວນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຄໍາສັ່ງລົບລ້າງຄໍາສັ່ງເປີດການສືບສວນ-ສອບສວນ</li>
            </ol>
          </div>
...
?>
        ...
        <td><a href="../basic-FrmOrderSam_List.php" class="btn btn-danger">Cancle</a></td>
