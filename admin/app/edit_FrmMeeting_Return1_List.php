...
<!-- ຟອມເພີ່ມນັກໂທດທົ່ວໄປທີ່ມີເງື່ອນໄຂສະເໜີໃຫ້ອະໄພຍະໂທດຜ່ອນໂທດທັງໝົດ -->
...
$sql="SELECT * FROM KHT_Sentence WHERE sentenceID='$sentenceID' ";
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="sentenceID" class="form-control" readonly value=<?=$sentenceID?>><br>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="Timetake" class="form-control" value="<?php echo $row['Timetake']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="Village" class="form-control" value="<?php echo $row['Village']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="Dtouch" class="form-control" value="<?php echo $row['date']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="Last_time" class="form-control" value="<?php echo $row['Last_time']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="N_year">ຈຳນວນປີ</label>
                      <input type="text" name="N_year" class="form-control" value="<?php echo $row['N_year']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="N_month">ຈຳນນເດືອນ</label>
                      <input type="text" name="N_month" class="form-control" value="<?php echo $row['N_month']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Re_main">ໂທດທີ່ຍັງເຫຼືອ</label>
                      <input type="text" name="Re_main" class="form-control" value="<?php echo $row['Re_main']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Date_for">ປະເພດດັດສ້າງ</label>
                      <input type="text" name="Date_for" class="form-control" value="<?php echo $row['Date_for']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="amnesty">ອະໄພຍະໂທດປີ</label>
                      <input type="text" name="amnesty" class="form-control" value="<?php echo $row['amnesty']?>"><br>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="Total1" class="form-control" value="<?php echo $row['Total1']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Paid1">ຈ່າຍແລ້ວ</label>
                      <input type="text" name="Paid1" class="form-control" value="<?php echo $row['Paid1']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="slacken">ຈຳນວນຜ່ອນ</label>
                      <input type="text" name="slacken" class="form-control" value="<?php echo $row['slacken']?>"><br>
        </div>

                    <div class="form-group">
                      <label for="Beleft1">ຍັງເຫຼືອ</label>
                      <input type="text" name="Beleft1" class="form-control" value="<?php echo $row['Beleft1']?>"><br>
        </div>
...
<input type="submit" value="Update" class="btn btn-success">
        <td><a href="../basic-FrmMeeting_Return1_List.php" class="btn btn-danger">Cancle</a></td>
