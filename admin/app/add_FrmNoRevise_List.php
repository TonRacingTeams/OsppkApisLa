                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="DisID">ລະຫັດ</label>
                      <input type="text" class="form-control" id="DisID" name="DisID" aria-describedby="DisID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Dreform">ຖືກຈັບຕົວວັນເດືອນປີ</label>
                      <input type="text" class="form-control" id="Dreform" name="Dreform" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Addhome" name="Addhome" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Datefor" name="Datefor" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="parentdeposit" name="parentdeposit" required>
                    </div>

                    <div class="form-group">
                      <label for="Dtimeups">ວັນເດືອນປີໝົດກຳນົດ</label>
                      <input type="text" class="form-control" id="Dtimeups" name="Dtimeups" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Dis_penMonth" name="Dis_penMonth" required>
                    </div>
