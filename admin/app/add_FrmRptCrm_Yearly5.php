      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຂໍ້ມູນຍອດຄ້າງມາ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຂໍ້ມູນຍອດຄ້າງມາ</li>
            </ol>
          </div>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Prov_ID">ລະຫັດ</label>
                      <input type="text" class="form-control" id="Prov_ID" name="Prov_ID" aria-describedby="Prov_ID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Order_No">ເລກນັບ</label>
                      <input type="password" class="form-control" id="Order_No" name="Order_No" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Quantity">ຈຳນວນຍອດຂ້າງມາ</label>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmRptCrm_Yearly5.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
