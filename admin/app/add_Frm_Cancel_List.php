...
<script>
    ...
    //  alert('hellow');
        ...
        var Office_NameE=$("#Office_NameE").val();


				$.post("search_FrmCancel_List.php",{
					Office_ID:Office_ID,
          Office_Name:Office_Name,
          Office_NameE:Office_NameE
				},
				function(output){
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີ່ມຂໍ້ມູນສຳນັກງານ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີ່ມຂໍ້ມູນສຳນັກງານ</li>
            </ol>
          </div>
                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      <label for="Office_ID">ລະຫັດ</label>
                      <input type="text" class="form-control" id="Office_ID" name="Office_ID" aria-describedby="Office_ID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Office_Name">ຊື່ສຳນັກງານ</label>
                      <input type="text" class="form-control" id="Office_Name" name="Office_Name" required>
                    </div>


                    <div class="form-group">
                      <label for="Office_NameE">Office Name</label>
                      <input type="text" class="form-control" id="Office_NameE" name="Office_NameE" required>
                    </div>
                   

          
                    <div class="form-group">
                      <label for="Address1">ທີ່ຢູ່ 1</label>
                      <input type="text" class="form-control" id="Address1" name="Address1" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Address1E">Address 1</label>
                      <input type="text" class="form-control" id="Address1E" name="Address1E" required>
                    </div>

                    <div class="form-group">
                      <label for="Address2">ທີ່ຢູ່ 2</label>
                      <input type="text" class="form-control" id="Address2" name="Address2" required>
                    </div>

                    <div class="form-group">
                      <label for="Address2E">Address 2</label>
                      <input type="password" class="form-control" id="Address2E" name="Address2E" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="E_mail">ອີເມວ</label>
                      <input type="text" class="form-control" id="E_mail" name="E_mail" required>
                    </div>

                    <div class="form-group">
                      <label for="Web_Site">Website</label>
                      <input type="text" class="form-control" id="Web_Site" name="Web_Site" required>
                    </div>

                    <div class="form-group">
                      <label for="Place">ທີ່</label>
                      <input type="text" class="form-control" id="Place" name="Place" required>
                    </div>

                    <div class="form-group">
                      <label for="PlaceE">Singned At</label>
                      <input type="text" class="form-control" id="PlaceE" name="PlaceE" required>
                    </div>

                    <div class="form-group">
                      <label for="Sign1">ລົງລາຍເຊັນ</label>
                      <input type="text" class="form-control" id="Sign1" name="Sign1" required>
                    </div>

                    <div class="form-group">
                      <label for="Sign1">Signature</label>
                      <input type="text" class="form-control" id="Sign1" name="Sign1" required>
                    </div>
            ...
            <div class="col-lg-6">
              <div class="card mb-4">     
                <div class="card-body">
                    ...
                    <a href='../basic-FrmCancel_List.php' class="btn btn-danger">ຍົກເລີກ</a>
                  </form>
                </div>
              </div>
