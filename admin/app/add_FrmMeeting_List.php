                 ...
                 <div class="card-body">
                  <!--<form action="saved_it_users_crm.php" name="frmAdd" method="POST"> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="ConvietID" name="ConvietID" aria-describedby="PrisonerID" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Kok_Name">ຊື່ນັກໂທດ</label>
                      <input type="text" class="form-control" id="Kok_Name" name="Kok_Name" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_surname">ນາມສະກຸນ</label>
                      <input type="text" class="form-control" id="Kok_surname" name="Kok_surname" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_timemake">ອາຍຸເວລາກະທຳຜິດ</label>
                      <input type="text" class="form-control" id="Kok_timemake" name="Kok_timemake" required>
                    </div>

                    <div class="form-group">
                      <label for="kok_sex">ເພດ</label>
                      <input type="text" class="form-control" id="kok_sex" name="kok_sex" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_National">ສັນຊາດ</label>
                      <input type="text" class="form-control" id="Kok_National" name="Kok_National" required>
                    </div>


                    <div class="form-group">
                      <label for="befor_job">ກ່ອນຖືກ(ອາຊີບ)</label>
                      <input type="text" class="form-control" id="befor_job" name="befor_job" required>
                    </div>


                    <div class="form-group">
                      <label for="befor_Village">ບ້ານ</label>
                      <input type="text" class="form-control" id="befor_Village" name="befor_Village" required>
                    </div>


                    <div class="form-group">
                      <label for="befor_District">ເມືອງ</label>
                      <input type="text" class="form-control" id="befor_District" name="befor_District" required>
                    </div>


                    <div class="form-group">
                      <label for="befor_Province">ແຂວງ</label>
                      <input type="text" class="form-control" id="befor_Province" name="befor_Province" required>
                    </div>


                    <div class="form-group">
                      <label for="Kok_punish">ສານຕັດສິນລົງໂທດ</label>
                      <input type="text" class="form-control" id="Kok_punish" name="Kok_punish" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Kok_Dtouch" name="Kok_Dtouch" required>
                    </div>

                    <div class="form-group">
                      <label for="Con_count">ໄດ້ຮັບການຜ່ອນໂທດ(ຈຳນວນຄັ້ງ)</label>
                      <input type="text" class="form-control" id="Con_count" name="Con_count" required>
                    </div>

                    <div class="form-group">
                      <label for="Con_year">ຈຳນວນປີ</label>
                      <input type="text" class="form-control" id="Con_year" name="Con_year" required>
                    </div>


                    <div class="form-group">
                      <label for="Con_month">ຈັກເດືອນ</label>
                      <input type="text" class="form-control" id="Con_month" name="Con_month" required>
                    </div>


                    <div class="form-group">
                      <label for="Con_Datefor">ປະເພດດັດສ້າງ</label>
                      <input type="text" class="form-control" id="Con_Datefor" name="Con_Datefor" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Beleft" name="Beleft" required>
                    </div>

                    <div class="form-group">
                      <label for="Brithday">ວັນເດືອນປີໝົດໂທດ</label>
                      <input type="text" class="form-control" id="Brithday" name="Brithday" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_Total">ຄ່າປັບໄໝ(ຈຳນວນລວມ)</label>
                      <input type="text" class="form-control" id="Kok_Total" name="Kok_Total" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_Paid">ຈ່າຍແລ້ວ</label>
                      <input type="text" class="form-control" id="Kok_Paid" name="Kok_Paid" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_Slacken">ຈຳນວນຜ່ອນ</label>
                      <input type="text" class="form-control" id="Kok_Slacken" name="Kok_Slacken" required>
                    </div>

                    <div class="form-group">
                      <label for="Kok_Beleft">ຍັງເຫຼືອ</label>
                      <input type="text" class="form-control" id="Kok_Beleft" name="Kok_Beleft" required>
                    </div>
