      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ເພີມຂໍ້ມູນສຳນັກງານ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ເພີມຂໍ້ມູນສຳນັກງານ</li>
            </ol>
          </div>
          ...
          <?php
             include '../server/connect.php';  
             $stmts = "SELECT MAX(Office_Name) AS Office_Name FROM KHT_Office";   
             $query = sqlsrv_query( $conn, $stmts);
             $results = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC);

            
             $max_id=$results['Office_Name'];
