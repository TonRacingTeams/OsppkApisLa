      ...
      <?php include('navbar.php')?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຄໍາສັ່ງບໍ່ເປີດການສືບສວນ-ສອບສວນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຄໍາສັ່ງບໍ່ເປີດການສືບສວນ-ສອບສວນ</li>
              ...
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                ?>
                    ...
                    <tbody id="users">
                        ...
                        <td align='center'>
                        <a href="app/edit_rrmrequesttruequt-list-load.php?Order_ID=<?PHP echo $result["Order_ID"]; ?>" class="btn btn-success"><i class="fas fa-edit fa-sm"></i> </a>
                        </td>
                        <td align='center'>
                        <a href="pages/delete_rrmrequesttruequt-list-load.php?Order_ID=<?php echo $result['Order_ID']?>" class="btn btn-danger"  onclick=" return confirm('ທານຕ້ອງການລົບຂໍ້ມູນນີ້ແທ້ ຫຼື ບໍ..?')"><i class="fas fa-trash fa-sm"></i></a>
                        </td>
