      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມອັບເດດຂໍ້ມູນຕາມໝວດ ແລະ ມາດຕາການກະທຳຜິດ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມອັບເດດຂໍ້ມູນຕາມໝວດ ແລະ ມາດຕາການກະທຳຜິດ</li>
            </ol>
          </div>
          ...
          <?php
             ...
             $stmt = "SELECT * FROM KHT_Rpt_SumByLaws WHERE Group_ID = ? ";   
            ...
            <div class="col-lg-6">
              ...
              <form action="update_users_crm.php" name="frmAdd" method="POST">
                    ...
                    <div class="form-group">
                      <label for="Group_ID">ລະຫັດໝວດ</label>
                      <input type="text" class="form-control" id="Group_ID" name="Group_ID" aria-describedby="Group_ID" required>
                    </div>

                    <div class="form-group">
                      <label for="Group_No">ໝວດ</label>
                      <input type="text" class="form-control" id="Group_No" name = "Group_No" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Group_name">ລາຍກການກຳທຳຜິດ</label>
                      <input type="text" class="form-control" id="Group_name " name = "Group_name" required>
                    </div>

                    <div class="form-group">
                      <label for="Law_No">ລະຫັດມາດຕາ</label>
                      <input type="text" class="form-control" id="Law_No" name = "Law_No" required>
                    </div>

                    <div class="form-group">
                      <label for="Law_Name">ມາດຕາ</label>
                      <input type="text" class="form-control" id="Law_Name" name="Law_Name" aria-describedby="Law_Name" required>
                    </div>

                    <div class="form-group">
                      <label for="Quantity">ກ່ຽວກັບມາດຕາ</label>
                    ...
                    <button type="submit" class="btn btn-primary">ບັນທືກ</button>
                      <a href='../basic-FrmUser2.php' class="btn btn-danger" onclick="window.exit();">ກັບຄືນ</a>
                    </div>
...
function Writes_bits() {
	var Writes_bits = document.getElementById("Writes_bits");
  if (Writes_bits.checked == true){
    Writes_bits.value = "1";
  } else {
    Writes_bits.value = "";
  }
...
function Edits_bits() {
	var Edits_bits = document.getElementById("Edits_bits");
  if (Edits_bits.checked == true){
    Edits_bits.value = "1";
  } else {
    Edits_bits.value = "";
  }
...
function Deletes_bits() {
	var Deletes_bits = document.getElementById("Deletes_bits");
  if (Deletes_bits.checked == true){
    Deletes_bits.value = "1";
  } else {
    Deletes_bits.value = "";
  }
}
