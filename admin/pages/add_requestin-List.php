...
<!-- <script>
      ...
      alert('hellow');
			$("#search").click(function(){
				...
				$.post("search_requestin-List.php",{
					Law_ID:Law_ID
				},
				function(output){
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມເພີມສຳນວນຄະດີອາຍາ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມເພີມສຳນວນຄະດີອາຍາ</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="saved_requestin-List.php" name="frmAdd" method="GET">


                  <!-- <div class="form-group">
                      <label for="Usr_id">ລຳດັບ</label>
                      <input type="text" class="form-control" id="Usr_id" name="Usr_id" aria-describedby="Usr_id" required>
                    </div> -->

                    <div class="form-group">
                      <label for="Item_ID">ລຳດັບ</label>
                      <input type="text" class="form-control" id="Item_ID" name="Item_ID" required>
                    </div>

                    <div class="form-group">
                      <label for="Item_No">ລະຫັດຄະດີ</label>
                      <input type="password" class="form-control" id="Item_No" name="Item_No" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Item_Date">ເລກທີຂາເຂົ້າ</label>
                      <input type="password" class="form-control" id="Item_Date" name="Item_Date" required>
                    </div>

                    <div class="form-group">
                      <label for="Sam_No">ວັນເດືອນປີເຂົ້າ</label>
                      <input type="password" class="form-control" id="Sam_No" name="Sam_No" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Item_Date_sam">ເລກທີ່ສຳນວນ</label>
                      <input type="text" class="form-control" id="Item_Date_sam" name="Item_Date_sam" required>
                    </div>

                    <div class="form-group">
                      <label for="Request_Crim">ວັນທີ່ລົງສຳນວນ</label>
                      <input type="password" class="form-control" id="Request_Crim" name="Request_Crim" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Related_Pers">ໂຈດທາງອາຍາ</label>
                      <input type="password" class="form-control" id="Related_Pers" name="Related_Pers" required>
                    </div>

                    <div class="form-group">
                      <label for="Respond_Civil">ຈຳເລີຍ</label>
                      <input type="password" class="form-control" id="Respond_Civil" name="Respond_Civil" required>
                    </div>

                    <div class="form-group">
                      <label for="Request_Civil">ໂຈດທາງແພ່ງ</label>
                      <input type="text" class="form-control" id="Request_Civil" name="Request_Civil" required>
                    </div>

                    <div class="form-group">
                      <label for="Problem">ບຸກຄົນທີສາມ</label>
                      <input type="password" class="form-control" id="Problem" name="Problem" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Kung">ຖືກຫາວ່າ</label>
                      <input type="password" class="form-control" id="Kung" name="Kung" required>
                    </div>

                    <div class="form-group">
                      <label for="Poy">ວັນທີກັກຕົວ</label>
                      <input type="password" class="form-control" id="Poy" name="Poy" required>
                    </div>

                    <div class="form-group">
                      <label for="sathan">ວັນທີປ່ອຍຕົວພາງ</label>
                      <input type="text" class="form-control" id="sathan" name="sathan" required>
                    </div>

                    <div class="form-group">
                      <label for="Dept_Respond">ສະຖານທີ່ກັກຂັງ</label>
                      <input type="password" class="form-control" id="Dept_Respond" name="Dept_Respond" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Staff_Respond">ໜ່ວຍງານຮັບຜິດຊອບ</label>
                      <input type="password" class="form-control" id="Staff_Respond" name="Staff_Respond" required>
                    </div>
