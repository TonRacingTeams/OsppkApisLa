...
?>
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and KHT_Order_Setup_Translate.date between '$start' and '$end'";}

                if($Order_ID==""){$d="";}
                else{ $d="and (KHT_Order_Setup_Translate.Order_ID like N'%$Order_ID%' or KHT_Order_Setup_Translate.Order_ID like N'$Order_ID%')";}
