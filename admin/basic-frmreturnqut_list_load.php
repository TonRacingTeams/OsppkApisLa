        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">ຄໍາສັ່ງກັກຕົວ</li>
              ...
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                <div class="input-group">
                  ...
                  <div class="col-lg-2">
                   ...
                   <lable>ເລກທີຄຳສັ່ງ</lable>
                    ...
                    <a href="app/add_frmreturnqut_list_load.php" class="btn btn-success"><i class="fas fa-plus fa-sm"></i> </a>
                    </div>
                  </div>
                ...
                ?>
                    ...
                    <tbody id="users">
                        ...
                        <td align='center'>
                        <a href="app/edit_frmreturnqut_list_load.php?Order_ID=<?PHP echo $result["Order_ID"]; ?>" class="btn btn-success"><i class="fas fa-edit fa-sm"></i> </a>
                        </td>
                        <td align='center'>
